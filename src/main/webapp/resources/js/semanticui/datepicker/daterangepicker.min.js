!function (t, e) {
    ...
    s.prototype = {
        constructor: s, setOptions: function (t, e) {
            if (this.startDate = a().startOf("day"), this.endDate = a().endOf("day"), this.timeZone = a().utcOffset(), this.minDate = !1, this.maxDate = !1, this.dateLimit = !1, this.showDropdowns = !1, this.showWeekNumbers = !1, this.timePicker = !1, this.timePickerSeconds = !1, this.timePickerIncrement = 30, this.timePicker12Hour = !0, this.singleDatePicker = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = ["ui", "compact", "small", "button"], this.applyClass = "primary", this.cancelClass = "secondary", this.format = "MM/DD/YYYY", this.separator = " - ", this.locale = {
                    applyLabel: "Apply",
                    cancelLabel: "Cancel",
                    fromLabel: "From",
                    toLabel: "To",
            ...
            "undefined" != typeof t.ranges || this.singleDatePicker || this.container.addClass("show-calendar"), this.container.removeClass("opensleft opensright").addClass("opens" + this.opens), this.updateView(), this.updateCalendars();
            ...
            if (this.chosenLabel = this.locale.customRangeLabel, t.isAfter(e)) {
                ...
                e = a(t).add(i, "ms"), this.maxDate && e.isAfter(this.maxDate) && (e = this.maxDate.clone())
            }
            ...
            var g, y, k = a([m, d, D, 12, s, n]).utcOffset(this.timeZone);
            ...
            for (var i = t.month(), s = t.year(), n = a && a.year() || s + 5, r = e && e.year() || s - 50, o = '<select class="ui compact selection dropdown monthselect">', h = s == r, l = s == n, c = 0; 12 > c; c++)(!h || c >= e.month()) && (!l || c <= a.month()) && (o += "<option value='" + c + "'" + (c === i ? " selected='selected'" : "") + ">" + this.locale.monthNames[c] + "</option>");
            o += "</select>";
            for (var d = '<select class="ui compact selection dropdown yearselect">', m = r; n >= m; m++)d += '<option value="' + m + '"' + (m === s ? ' selected="selected"' : "") + ">" + m + "</option>";
            return d += "</select>", o + d
        }, renderCalendar: function (t, e, a, s, n) {
            var r = '<div class="calendar-date">';
            r += '<table class="table-condensed">', r += "<thead>", r += "<tr>", this.showWeekNumbers && (r += "<th></th>"), r += !a || a.isBefore(t.firstDay) ? '<th class="prev available"><i class="left arrow icon"></i></th>' : "<th></th>";
            var o = this.locale.monthNames[t[1][1].month()] + t[1][1].format(" YYYY");
            this.showDropdowns && (o = this.renderDropdowns(t[1][1], a, s)), r += '<th colspan="5" class="month">' + o + "</th>", r += !s || s.isAfter(t.lastDay) ? '<th class="next available"><i class="right arrow icon"></i></th>' : "<th></th>", r += "</tr>", r += "<tr>", this.showWeekNumbers && (r += '<th class="week">' + this.locale.weekLabel + "</th>"), i.each(this.locale.daysOfWeek, function (t, e) {
                r += "<th>" + e + "</th>"
            ...
            var m;
            if (this.timePicker) {
                r += '<div class="calendar-time">', r += '<select class="ui compact upward selection dropdown hourselect">';
                var f = 0, p = 23;
                ...
                r += "</select> : ", r += '<select class="ui compact upward selection dropdown minuteselect">';
                var y = 0, k = 59;
                for (a && ("left" == n || this.singleDatePicker) && e.format("YYYY-MM-DD h A") == a.format("YYYY-MM-DD h A") && (y = a.minute(), e.minute() < y && e.minute(y)), s && ("right" == n || this.singleDatePicker) && e.format("YYYY-MM-DD h A") == s.format("YYYY-MM-DD h A") && (k = s.minute(), e.minute() > k && e.minute(k)), m = 0; 60 > m; m += this.timePickerIncrement) {
                    var v = m;
                    10 > v && (v = "0" + v), r += m == e.minute() ? '<option value="' + m + '" selected="selected">' + v + "</option>" : y > m || m > k ? '<option value="' + m + '" disabled="disabled" class="disabled">' + v + "</option>" : '<option value="' + m + '">' + v + "</option>"
                }
                ...
                if (this.timePicker12Hour) {
                    r += '<select class="ui compact upward selection dropdown ampmselect">';
                    var C = "", Y = "";
                    a && ("left" == n || this.singleDatePicker) && e.format("YYYY-MM-DD") == a.format("YYYY-MM-DD") && a.hour() >= 12 && (C = ' disabled="disabled" class="disabled"'), s && ("right" == n || this.singleDatePicker) && e.format("YYYY-MM-DD") == s.format("YYYY-MM-DD") && s.hour() < 12 && (Y = ' disabled="disabled" class="disabled"'), r += e.hour() >= 12 ? '<option value="AM"' + C + '>AM</option><option value="PM" selected="selected"' + Y + ">PM</option>" : '<option value="AM" selected="selected"' + C + '>AM</option><option value="PM"' + Y + ">PM</option>", r += "</select>"
                }
                r += "</div>"
            }
            return r
