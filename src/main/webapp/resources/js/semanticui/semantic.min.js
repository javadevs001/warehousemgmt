            ...
            O = {
                initialize: function () {
                    ...
                    f.each(function () {
                        ...
                        r === i && (r = ""), l && (O.verbose("Resetting error on field", o), o.removeClass(S.error), a.remove()), c ? (O.verbose("Resetting dropdown value", n, r), n.dropdown("restore defaults")) : s ? (O.verbose("Resetting checkbox value", n, r), t.prop("checked", r)) : (O.verbose("Resetting field value", t, r), t.val(r))
                    })
                }, is: {
                    valid: function () {
                        var t = !0;
        ...
        return a.each(function () {
            ...
            m = {
                initialize: function () {
                    ...
                    checked: function () {
                        return !m.is.indeterminate() && m.is.checked() ? void m.debug("Input is already checked") : (m.verbose("Setting state to checked", w[0]), m.is.radio() && m.uncheckOthers(), w.prop("indeterminate", !1).prop("checked", !0),
                            x.removeClass(g.indeterminate).addClass(g.checked), void m.trigger.change())
                    }, unchecked: function () {
                        return !m.is.indeterminate() && m.is.unchecked() ? void m.debug("Input is already unchecked") : (m.debug("Setting state to unchecked"), w.prop("indeterminate", !1).prop("checked", !1), x.removeClass(g.indeterminate).removeClass(g.checked), void m.trigger.change())
                    }, indeterminate: function () {
                        return m.is.indeterminate() ? void m.debug("Input is already indeterminate") : (m.debug("Setting state to indeterminate"), w.prop("indeterminate", !0), x.addClass(g.indeterminate), void m.trigger.change())
                    }, determinate: function () {
                        return m.is.determinate() ? void m.debug("Input is already determinate") : (m.debug("Setting state to determinate"), w.prop("indeterminate", !1), void x.removeClass(g.indeterminate))
                    }, disabled: function () {
                        return m.is.disabled() ? void m.debug("Input is already disabled") : (m.debug("Setting state to disabled"), w.prop("disabled", "disabled"), x.addClass(g.disabled), void m.trigger.change())
                    }, enabled: function () {
                        return m.is.enabled() ? void m.debug("Input is already enabled") : (m.debug("Setting state to enabled"), w.prop("disabled", !1), x.removeClass(g.disabled), void m.trigger.change())
                    }, tabbable: function () {
        ...
        return a.each(function () {
            ...
            f = {
                preinitialize: function () {
                    ...
                    f.debug("Initializing dimmer", g), "hover" == g.on ? m.on("mouseenter" + y, f.show).on("mouseleave" + y, f.hide) : "click" == g.on && m.on(w + y, f.toggle), f.is.page() && (f.debug("Setting as a page dimmer", m), f.set.pageDimmer()), f.is.closable() && (f.verbose("Adding dimmer close event", d), m.on(w + y, p.dimmer, f.event.click)), f.set.dimmable(), f.instantiate()
                }, instantiate: function () {
                    f.verbose("Storing instance of module", f), T = f, k.data(x, T)
                }, destroy: function () {
                    f.verbose("Destroying previous module", d), k.removeData(x), m.off(y)
                }, event: {
                    click: function (t) {
            ...
            w = {
                initialize: function () {
                    ...
                    keyboardEvents: function () {
                        ...
                        w.debug("Touch device detected binding additional touch events"), w.is.searchSelection() || j.on("touchstart" + D, w.event.test.toggle), M.on("touchstart" + D, E.item, w.event.item.mouseenter)
                    ...
                    focus: function () {
                        ...
                        var n = e(t.target);
                        !n.is(j) && !n.is(H) || w.is.focusedOnSearch() || w.focusSearch()
                    }, blur: function (e) {
                        ...
                        if (i) {
                            ...
                            if (w.is.visible()) {
                                if ((t == n.enter || t == n.delimiter) && (t == n.enter && g && f && !k.allowCategorySelection ? (w.verbose("Pressed enter on unselectable category, opening sub menu"), t = n.rightArrow) : p && (w.verbose("Selecting item from keyboard shortcut", c), w.event.item.click.call(c, e), k.useLabels && w.is.searchSelection() ? w.hideAndClear() : w.remove.searchTerm()), e.preventDefault()), t == n.leftArrow && (a = d[0] !== M[0], a && (w.verbose("Left key pressed, closing sub-menu"), w.animate.hide(!1, d), c.removeClass(S.selected), d.closest(E.item).addClass(S.selected), e.preventDefault())), t == n.rightArrow && f && (w.verbose("Right key pressed, opening sub-menu"), w.animate.show(!1, u), c.removeClass(S.selected), u.find(E.item).eq(0).addClass(S.selected), e.preventDefault()), t == n.upArrow) {
            ...
            y = {
                initialize: function () {
                    ...
                    position: function (e, t) {
                        ...
                        var o, a, r, s, c, l, u;
                        if (t = t || y.get.calculations(), e = e || P.data(S.position) || x.position, o = P.data(S.offset) || x.offset, a = x.distanceAway, r = t.target, s = t.popup, c = t.parent, 0 === r.top && 0 === r.left)return y.debug("Popup target is hidden, no action taken"), !1;
            ...
            m = {
                initialize: function () {
                    ...
                    metadata: function () {
                        ...
                        e.percent && (m.debug("Current percent value set from metadata", e.percent), m.set.percent(e.percent)), e.total && (m.debug("Total value set from metadata", e.total), m.set.total(e.total)), e.value && (m.debug("Current value set from metadata", e.value), m.set.value(e.value))
                    }, settings: function () {
            ...
            g = {
                initialize: function () {
                    ...
                    above: function () {
                        ...
                        }), t.css({transform: "rotateY(0deg) translateZ(" + e.depth.active + "px)"}), f.addClass(x.animating).css({
                            top: e.origin + "px",
                ...
                initialize: function () {
                    ...
                    n = b.utilities.arrayToPath(r), e.each(r, function (t, i) {
                        ...
                        if (b.verbose("Looking for tab", i), f) {
                            if (b.verbose("Tab was found", i), v = m, h = b.utilities.filterArray(r, d), p ? u = !0 : (c = r.slice(0, t + 2), l = b.utilities.arrayToPath(c), u = !b.is.tab(l), u && b.verbose("Tab parameters found", c)), u && a)return o ? (b.debug("Ignoring remote content on first tab load", m), E = !1,
                                b.cache.add(n, w.html()), b.activate.all(m), x.onFirstLoad.call(w[0], m, h, y), x.onLoad.call(w[0], m, h, y)) : (b.activate.navigation(m), b.fetch.content(m, n)), !1;
