...
public class OneShotConfig {
    ...
    public PropertyPlaceholderConfigurer propertyPlaceholderConfigurer() throws FileNotFoundException {
        ...
        /* TODO CHANGE */
        ppc.setLocation(new InputStreamResource(new FileInputStream(new File("C:\\IdeaProjects\\warehousemgmt\\src\\main\\resources\\config\\" + System.getenv("env") + "/warehousemgmt.properties"))));
        return ppc;
    }
}
